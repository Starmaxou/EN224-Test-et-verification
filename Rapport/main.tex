...
\lstdefinelanguage{VHDL}{
   morekeywords=[1]{
     ...
     IS, PORT, IN, OUT, END, ARCHITECTURE, OF, BEGIN, AND, ASSERT, wait, while, SEVERITY
   },
   morekeywords=[2]{
     STD_LOGIC_VECTOR,STD_LOGIC,IEEE,STD_LOGIC_1164,
     NUMERIC_STD,STD_LOGIC_ARITH,STD_LOGIC_UNSIGNED,std_logic_vector,
     std_logic, downto, DOWNTO, UNSIGNED, TO_UNSIGNED, to_unsigned, ERROR
   },
   morecomment=[l]--
}
\lstdefinestyle{vhdl}{
...
\end{lstlisting}
         ...
         Elles n'empêche pas l'erreur de ce produire mais permettent d'éviter le déroulement 
         du programme dans des conditions connues comme mauvaise.
...
\end{lstlisting}
        ...
        Elles permettent de vérifier que le résultat de la fonction est mathatiquement cohérent avec ses entrées.
        Elles ne permettant pas de valider le fonctionnement de la fonction mais de détécter des cas d'erreurs connus.
    \subsection{Etape 6}
...
\end{figure}
        ...
        Une fois ce squelette décrit, il ne reste plus qu'a créer les stimulis pour le module à tester.
    ...
    \subsection{Etape 2}
        ...
        Ces assertions seront écrite dans le fichier testbench.
    \subsection{Etape 3}
...
\end{lstlisting}
        Avec cette méthode, on peut générer autant de test que l'on souhaite et donc gagner énormement de temps.
        Cependant, pour utiliser cette méthode il faut être sûre du bon fonctionnement de la fonction réalisant les pgcds des couples de tests.

\section{Conclusion} % Conclusion
Tout le code du TP est disponible dans mon repository GIT https://github.com/Starmaxou/EN224-Test-et-verification
\begin{lstlisting}[style=CStyle]
